...
const ITEMS = [
  { icon: CalendarDays, label: "Daily Stays" },
  { icon: CalendarRange, label: "Weekly Stays" },
  { icon: CalendarClock, label: "Monthly Stays" },
  { icon: BedDouble, label: "Single & Double Rooms" },
];
